  ...
  module Generators
    class InstallGenerator < Rails::Generators::Base
      ...
      def add_assets
        ...
        settings_file = File.join(File.dirname(__FILE__),"..","..","..","scss","foundation","_settings.scss")
        create_file "app/assets/stylesheets/foundation_and_overrides.scss", File.read(settings_file)
        functions_file = File.join(File.dirname(__FILE__),"..","..","..","scss","foundation","_functions.scss")
        append_to_file "app/assets/stylesheets/foundation_and_overrides.scss", File.read(functions_file)
